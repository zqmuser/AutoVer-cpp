...
I'm saving this file to remind me of the git commands.
...
Once those are installed, make git track the project.
```bash
git --version
git init -b main
git add .
...
Example using AutoVerCommit
```bash
AutoVerCommit "MY COMMENT HERE"
git push origin v1.0.2
git push origin main
```
